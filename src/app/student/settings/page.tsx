    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="rounded-xl border border-gray-200 bg-white shadow-sm p-16 flex flex-col items-center justify-center min-h-[300px] gap-4">
        ...
        <div className="text-center">
          <p className="font-semibold text-gray-700">Settings coming soon</p>
          <p className="text-sm text-gray-400 mt-1">Account preferences and notification settings will appear here.</p>
        </div>
      </div>
    </div>
  );
