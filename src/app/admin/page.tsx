...
const BRANCH_COLORS: Record<string, string> = {
  CSE: "border-orange-200 hover:border-orange-400 hover:bg-orange-50",
  ECE: "border-orange-200 hover:border-orange-400 hover:bg-orange-50",
    ...
    <div className="max-w-6xl mx-auto space-y-8">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">
          Here&apos;s an overview of the college.
        </p>
      </div>
        ...
        <div className="flex flex-wrap gap-3">
          {QUICK_LINKS.map((link) => (
            <Link
              key={link.href}
              href={link.href}
              className="flex items-center gap-2 px-4 py-2.5 bg-white border border-gray-200 rounded-lg text-sm text-gray-700 hover:border-orange-300 hover:text-orange-700 hover:bg-orange-50 transition-colors font-medium"
            >
              <link.icon size={15} />
              {link.label}
            </Link>
